 ...
 */
public class Fragment0_5 extends Fragment implements ScreenSlidePagerActivity.ISetTextInFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(MainActivity.fragNum == 1){
            fragStringCommon1 = "Fragment 1, Main tag 1, Sub Tag 6, String 1";
            fragStringCommon2 = "Fragment 1, Main tag 1, Sub Tag 6, String 2";
            fragStringCommon3 = "Fragment 1, Main tag 1, Sub Tag 6, String 3";
        } else if(MainActivity.fragNum == 2){
            fragStringCommon1 = "Fragment 2, Main tag 1, Sub Tag 6, String 1";
            fragStringCommon2 = "Fragment 2, Main tag 1, Sub Tag 6, String 2";
            fragStringCommon3 = "Fragment 2, Main tag 1, Sub Tag 6, String 3";
        } else if(MainActivity.fragNum == 3){
            fragStringCommon1 = "Fragment 3, Main tag 1, Sub Tag 6, String 1";
            fragStringCommon2 = "Fragment 3, Main tag 1, Sub Tag 6, String 2";
            fragStringCommon3 = "Fragment 3, Main tag 1, Sub Tag 6, String 3";
        } else if(MainActivity.fragNum == 4){
            fragStringCommon1 = "Fragment 4, Main tag 1, Sub Tag 6, String 1";
            fragStringCommon2 = "Fragment 4, Main tag 1, Sub Tag 6, String 2";
            fragStringCommon3 = "Fragment 4, Main tag 1, Sub Tag 6, String 3";
        } else {
            fragStringCommon1 = "Fragment 5, Main tag 1, Sub Tag 6, String 1";
            fragStringCommon2 = "Fragment 5, Main tag 1, Sub Tag 6, String 2";
            fragStringCommon3 = "Fragment 5, Main tag 1, Sub Tag 6, String 3";
        }
