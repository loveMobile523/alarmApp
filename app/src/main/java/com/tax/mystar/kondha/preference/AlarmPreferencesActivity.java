package com.tax.mystar.kondha.preference;
...
import com.tax.mystar.kondha.alarm.BaseActivity;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                startActivity(new Intent(AlarmPreferencesActivity.this, AlarmActivity.class));
                finish();
                break;
        }
